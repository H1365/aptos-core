...
/// Identifies if the data client response fully satisfies the
/// requested data, i.e., all requested data appears to have been
/// received. If not, this method returns a data client request
/// that can be sent to the network to retrieve the missing data.
...
/// Calculates the number of items difference between the given
